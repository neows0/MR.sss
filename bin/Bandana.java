...
public class Bandana extends Item {
    public Bandana(Handler handler, Player owner) {
	super(ITMID.Bandana, handler, owner);
    ...
    public Bandana(int x, int y, Handler handler, boolean onGround){
	super(x, y, ITMID.Bandana, handler, onGround);
	imgs = Game.images.getDir("bandana");
	if (imgs == null)
	    System.out.println("Error");
